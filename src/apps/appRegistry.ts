...
export const APP_REGISTRY: AppDef[] = [
  { id: 'mail', label: 'Mail', iconPath: '/assets/apps/Mail.webp', component: MailPlaceholder },
  { id: 'calendar', label: 'Calendar', iconPath: '/assets/apps/Calendar.webp', component: CalendarPlaceholder },
  { id: 'photos', label: 'Photos', iconPath: '/assets/apps/Photos.webp', component: PhotosPlaceholder },
  { id: 'caremore', label: 'Care More', iconPath: '/assets/icons/CareMore.webp', component: CareMorePlaceholder },
...
export const DOCK_APP_IDS = ['music'] as const;
